...
public class QuizQuestionAndAnswers extends AbstractQuiz implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int selectedLevel = Objects.requireNonNull(getIntent().getExtras()).getInt("SelectedLevel");
        ...
        if (savedInstanceState != null) {
            this.questionId = savedInstanceState.getInt(saveQuestionId);
            this.wrongAnswerCount = savedInstanceState.getInt(saveWrongAnswerCount);
            this.correctAnswerCount = savedInstanceState.getInt(saveCorrectAnswerCount);
            this.randomQuestionKeys = savedInstanceState.getIntArray(saveRandomQuestionKeys);
        }
