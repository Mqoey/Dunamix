...
public class GalleryFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  new DataRetriever(GalleryFragment.this).retrieve(recyclerView,myDataLoaderProgressBar);
    ...
    public static class DataRetriever {
        ...
        private static final String PHP_MYSQL_SITE_URL="http://dunamixapp.000webhostapp.com/";
        //INSTANCE FIELDS
         ...
         */
        public void retrieve(final RecyclerView recyclerView, final ProgressBar myProgressBar)
        {
            final ArrayList<GalleryModel> pictures = new ArrayList<>();
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try
                            {
                                for(int i=0;i<response.length();i++)
                                {
                                    ...
                                    picture= new GalleryModel(name, description, PHP_MYSQL_SITE_URL + "images/" + imageURL, id);
                                    pictures.add(picture);
                                }
//                                //SET TO SPINNER
                                adapter = new GalleryAdapter(c, pictures);
                                recyclerView.setAdapter(adapter);
