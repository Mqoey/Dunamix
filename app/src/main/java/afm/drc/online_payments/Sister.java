...
public class Sister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tithe.setText("Sister Union Funds");
...
//If the app doesn’t have the CALL_PHONE permission, request it//
            ...
            public void onClick(View view) {
                {
                    ...
                    if (!TextUtils.isEmpty(pay)) {
                        String dial = "tel:*151*2*2*37844*" + pay + "%23";
                        if (ActivityCompat.checkSelfPermission(Sister.this,
                                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            return;
                        }
                        startActivity(new Intent(Intent.ACTION_CALL, Uri.parse(dial)));
                    }
                    else Toast.makeText(Sister.this,
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(Sister.this, new String[]
                {
